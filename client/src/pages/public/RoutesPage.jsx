                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        {routes.map((route) => (
                            <div
                                ...
                                className="bg-white/80 dark:bg-[#0F1D36]/80 backdrop-blur-md border border-slate-200/60 dark:border-sky-950/50 rounded-3xl p-6 shadow-sm hover:shadow-lg hover:-translate-y-1.5 hover:scale-[1.02] active:scale-[0.99] transition-all duration-300 flex flex-col justify-between gap-5"
                            >
